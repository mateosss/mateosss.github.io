...
```bash
$ python timing.py runs/BNF/EV201/timing.csv tracker_pushed vio_produced -p
...
```bash
$ python completion.py runs/K/TR1/tracking.csv targets/TR1/cam0.csv
|:---------------------|:--------|
...
```bash
$ python tracking.py ate runs/BNF/EV201/tracking.csv targets/EV201/gt.csv
...
$ python tracking.py rte runs/BNF/EV201/tracking.csv targets/EV201/gt.csv -p
...
[^realtime-gt-error-note]: This only happens if the SLAM data source reports a
